...
position_r = max_nonzero_index(to106_0_001, to108_0_001, to112_0_001)
...
to106_0_001 = zeros + to106_0_001
zeros = [0] * (int(step108[0]))
to108_0_001 = zeros + to108_0_001
zeros = [0] * (int(step112[0]))
to112_0_001 = zeros + to112_0_001
