...
for epoch_i in range(0, 10):
    ...
    if epoch_i != 9:
        ...
        data1 = ([0] * (int(step106[epoch_i]) - int(x_l))) + (to106_0_0001[int(step106[epoch_i]): int(x_l + 8000)])
        data2 = ([0] * (int(step108[epoch_i]) - int(x_l))) + (to108_0_0001[int(step108[epoch_i]): int(x_l + 8000)])
        data3 = ([0] * (int(step112[epoch_i]) - int(x_l))) + (to112_0_0001[int(step112[epoch_i]): int(x_l + 8000)])
